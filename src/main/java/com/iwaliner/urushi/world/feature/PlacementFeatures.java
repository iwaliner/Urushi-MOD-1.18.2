...
public class PlacementFeatures {
    ...
    public static final Holder<PlacedFeature> AJISAI_FLOWERS = PlacementUtils.register("ajisai_flowers", FeatureGenerator.AJISAI_FLOWERS, RarityFilter.onAverageOnceEvery(40), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, CountPlacement.of(ClampedInt.of(UniformInt.of(-2, 6), 0, 10)), BiomeFilter.biome());
