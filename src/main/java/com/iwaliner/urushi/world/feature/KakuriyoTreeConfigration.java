...
public class KakuriyoTreeConfigration extends TreeConfiguration {
    protected KakuriyoTreeConfigration(BlockStateProvider p_191337_, TrunkPlacer p_191338_, BlockStateProvider p_191339_, FoliagePlacer p_191340_, BlockStateProvider p_191341_, FeatureSize p_191342_, List<TreeDecorator> p_191343_, boolean p_191344_, boolean p_191345_) {
        super(p_191337_, p_191338_, p_191339_, p_191340_, p_191341_, p_191342_, p_191343_, p_191344_, p_191345_);
    }
    public static class KakuriyoTreeConfigurationBuilder {
        ...
        public KakuriyoTreeConfigration build() {
            return new KakuriyoTreeConfigration(this.trunkProvider, this.trunkPlacer, this.foliageProvider, this.foliagePlacer, this.dirtProvider, this.minimumSize, this.decorators, this.ignoreVines, this.forceDirt);
        }
    }
}
