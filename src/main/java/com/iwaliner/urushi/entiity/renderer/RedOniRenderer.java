...
public class RedOniRenderer extends HumanoidMobRenderer<RedOniEntity, RedOniModel<RedOniEntity>> {
    ...
    public RedOniRenderer(EntityRendererProvider.Context p_174380_) {
        this(p_174380_, ModelLayers.ZOMBIE, ModelLayers.ZOMBIE_INNER_ARMOR, ModelLayers.ZOMBIE_OUTER_ARMOR);

    }

    public RedOniRenderer(EntityRendererProvider.Context p_174382_, ModelLayerLocation p_174383_, ModelLayerLocation p_174384_, ModelLayerLocation p_174385_) {
        super(p_174382_, new RedOniModel<>(p_174382_.bakeLayer(p_174383_)), 0.5F);
        this.addLayer(new HumanoidArmorLayer<>(this, new RedOniModel<>(p_174382_.bakeLayer(p_174384_)), new RedOniModel<>(p_174382_.bakeLayer(p_174385_))));
