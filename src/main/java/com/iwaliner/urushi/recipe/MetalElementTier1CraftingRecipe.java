...
public class MetalElementTier1CraftingRecipe extends AbstractElementCraftingRecipe{
    ...
    public static class MetalElementTier1CraftingSerializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<MetalElementTier1CraftingRecipe> {
