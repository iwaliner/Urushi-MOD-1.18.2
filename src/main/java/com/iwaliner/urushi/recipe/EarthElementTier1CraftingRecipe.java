...
public class EarthElementTier1CraftingRecipe extends AbstractElementCraftingRecipe{
    ...
    public static class EarthElementTier1CraftingSerializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<EarthElementTier1CraftingRecipe> {
