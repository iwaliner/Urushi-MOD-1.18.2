...
public class ItemAndBlockRegister {
    ...
    public static final RegistryObject<Block> oak_shitamiita =BW("oak_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> oak_shitamiita_slab =BW("oak_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> spruce_shitamiita =BW("spruce_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PODZOL).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> spruce_shitamiita_slab =BW("spruce_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PODZOL).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> birch_shitamiita =BW("birch_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> birch_shitamiita_slab =BW("birch_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> jungle_shitamiita =BW("jungle_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.DIRT).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> jungle_shitamiita_slab =BW("jungle_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.DIRT).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> acacia_shitamiita =BW("acacia_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> acacia_shitamiita_slab =BW("acacia_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> dark_oak_shitamiita =BW("dark_oak_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> dark_oak_shitamiita_slab =BW("dark_oak_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> japanese_apricot_shitamiita =BW("japanese_apricot_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_apricot_shitamiita_slab =BW("japanese_apricot_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> sakura_shitamiita =BW("sakura_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> sakura_shitamiita_slab =BW("sakura_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> cypress_shitamiita =BW("cypress_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> cypress_shitamiita_slab =BW("cypress_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> japanese_cedar_shitamiita =BW("japanese_cedar_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_cedar_shitamiita_slab =BW("japanese_cedar_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> red_urushi_shitamiita =BW("red_urushi_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> red_urushi_shitamiita_slab =BW("red_urushi_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> black_urushi_shitamiita =BW("black_urushi_shitamiita","a",-1,() -> {return new FlammableHorizonalRotateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> black_urushi_shitamiita_slab =BW("black_urushi_shitamiita_slab","a",-1,() -> {return new FlammableHorizonalRotateSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> wind_bell =B("wind_bell","n",-1,() -> {return new WIndBellBlock(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).sound(SoundType.GLASS).strength(0.2F, 10.0F).noOcclusion().noCollission());});
    ...
    public static final RegistryObject<Item> goldfish =ITEMS.register("goldfish", () -> {return new Item((new Item.Properties()).food(FoodUrushi.RawFish).tab(ModCoreUrushi.UrushiFoodTab));});
    public static final RegistryObject<Item> carp =ITEMS.register("carp", () -> {return new Item((new Item.Properties()).food(FoodUrushi.RawFish).tab(ModCoreUrushi.UrushiFoodTab));});
    ...
    public static final RegistryObject<Item> sweetfish_with_salt =ITEMS.register("sweetfish_with_salt", () -> {return new Item((new Item.Properties()).food(FoodUrushi.RawFishWithSalt).tab(ModCoreUrushi.UrushiFoodTab));});
    public static final RegistryObject<Item> cooked_sweetfish =ITEMS.register("cooked_sweetfish", () -> {return new Item((new Item.Properties()).food(FoodUrushi.CookedFish).tab(ModCoreUrushi.UrushiFoodTab));});
    public static final RegistryObject<Item> cooked_sweetfish_with_salt =ITEMS.register("cooked_sweetfish_with_salt", () -> {return new Item((new Item.Properties()).food(FoodUrushi.CookedFishWithSalt).tab(ModCoreUrushi.UrushiFoodTab));});
