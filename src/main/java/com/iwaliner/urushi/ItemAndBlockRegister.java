...
public class ItemAndBlockRegister {
    ...
    public static final RegistryObject<Block> green_tatami_carpet =B("green_tatami_carpet","h",-1,() -> {return new TwoDirectionShapedBlock(0.0D, 0.0D, 0.0D, 16.0D, 2.0D, 16.0D,BlockBehaviour.Properties.of(Material.GRASS, MaterialColor.GRASS).strength(0.2F, 10.0F).sound(SoundType.GRASS).noCollission());});
    ...
    public static final RegistryObject<Block> brown_tatami_carpet =B("brown_tatami_carpet","h",-1,() -> {return new TwoDirectionShapedBlock(0.0D, 0.0D, 0.0D, 16.0D, 2.0D, 16.0D,BlockBehaviour.Properties.of(Material.GRASS, MaterialColor.GRASS).strength(0.2F, 10.0F).sound(SoundType.GRASS).noOcclusion());});
    ...
    public static final RegistryObject<Block> smooth_oak_planks =BW("smooth_oak_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_oak_slab =BW("smooth_oak_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_oak_stairs =BW("smooth_oak_stairs","a",-1,() -> {return new StairBlock(smooth_oak_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_spruce_planks =BW("smooth_spruce_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PODZOL).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_spruce_slab =BW("smooth_spruce_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PODZOL).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_spruce_stairs =BW("smooth_spruce_stairs","a",-1,() -> {return new StairBlock(smooth_spruce_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PODZOL).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_birch_planks =BW("smooth_birch_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_birch_slab =BW("smooth_birch_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_birch_stairs =BW("smooth_birch_stairs","a",-1,() -> {return new StairBlock(smooth_birch_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_jungle_planks =BW("smooth_jungle_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.DIRT).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_jungle_slab =BW("smooth_jungle_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.DIRT).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_jungle_stairs =BW("smooth_jungle_stairs","a",-1,() -> {return new StairBlock(smooth_jungle_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.DIRT).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_acacia_planks =BW("smooth_acacia_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_acacia_slab =BW("smooth_acacia_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_acacia_stairs =BW("smooth_acacia_stairs","a",-1,() -> {return new StairBlock(smooth_acacia_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_dark_oak_planks =BW("smooth_dark_oak_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_dark_oak_slab =BW("smooth_dark_oak_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_dark_oak_stairs =BW("smooth_dark_oak_stairs","a",-1,() -> {return new StairBlock(smooth_dark_oak_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> red_sapling =BW("red_sapling","a",-1,() -> {return new SaplingBlock(new RedTreeGrower(),BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.COLOR_RED).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
    ...
    public static final RegistryObject<Block> orange_sapling =BW("orange_sapling","a",-1,() -> {return new SaplingBlock(new OrangeTreeGrower(),BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.COLOR_ORANGE).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
    ...
    public static final RegistryObject<Block> yellow_sapling =BW("yellow_sapling","a",-1,() -> {return new SaplingBlock(new YellowTreeGrower(),BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.COLOR_YELLOW).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
    ...
    public static final RegistryObject<Block> japanese_apricot_sapling =BW("japanese_apricot_sapling","a",-1,() -> {return new SaplingBlock(new ApricotTreeGrower(),BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.COLOR_PINK).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
    ...
    public static final RegistryObject<Block> japanese_apricot_planks =BW("japanese_apricot_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_apricot_slab =BW("japanese_apricot_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_apricot_stairs =BW("japanese_apricot_stairs","a",-1,() -> {return new StairBlock(japanese_apricot_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_apricot_fence =BW("japanese_apricot_fence","a",-1,() -> {return new FenceBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_apricot_fence_gate =BW("japanese_apricot_fence_gate","a",-1,() -> {return new FenceGateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_japanese_apricot_planks =BW("smooth_japanese_apricot_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_japanese_apricot_slab =BW("smooth_japanese_apricot_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_japanese_apricot_stairs =BW("smooth_japanese_apricot_stairs","a",-1,() -> {return new StairBlock(smooth_japanese_apricot_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> sakura_sapling =BW("sakura_sapling","a",-1,() -> {return new SaplingBlock(new SakuraTreeGrower(),BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_WHITE).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
    public static final RegistryObject<Block> big_sakura_sapling =BW("big_sakura_sapling","a",-1,() -> {return new SaplingBlock(new FancySakuraTreeGrower(),BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_WHITE).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
    ...
    public static final RegistryObject<Block> sakura_planks =BW("sakura_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> sakura_slab =BW("sakura_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> sakura_stairs =BW("sakura_stairs","a",-1,() -> {return new StairBlock(sakura_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> sakura_fence =BW("sakura_fence","a",-1,() -> {return new FenceBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> sakura_fence_gate =BW("sakura_fence_gate","a",-1,() -> {return new FenceGateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_sakura_planks =BW("smooth_sakura_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_sakura_slab =BW("smooth_sakura_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_sakura_stairs =BW("smooth_sakura_stairs","a",-1,() -> {return new StairBlock(smooth_sakura_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> cypress_sapling =BW("cypress_sapling","a",-1,() -> {return new SaplingBlock(new CypressTreeGrower(),BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.GRASS).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
    ...
    public static final RegistryObject<Block> cypress_planks =BW("cypress_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> cypress_slab =BW("cypress_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> cypress_stairs =BW("cypress_stairs","a",-1,() -> {return new StairBlock(cypress_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> cypress_fence =BW("cypress_fence","a",-1,() -> {return new FenceBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> cypress_fence_gate =BW("cypress_fence_gate","a",-1,() -> {return new FenceGateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_cypress_planks =BW("smooth_cypress_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_cypress_slab =BW("smooth_cypress_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_cypress_stairs =BW("smooth_cypress_stairs","a",-1,() -> {return new StairBlock(smooth_cypress_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> japanese_cedar_sapling =BW("japanese_cedar_sapling","a",-1,() -> {return new SaplingBlock(new CedarTreeGrower(),BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.COLOR_BROWN).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
    ...
    public static final RegistryObject<Block> japanese_cedar_planks =BW("japanese_cedar_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_cedar_slab =BW("japanese_cedar_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_cedar_stairs =BW("japanese_cedar_stairs","a",-1,() -> {return new StairBlock(cypress_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_cedar_fence =BW("japanese_cedar_fence","a",-1,() -> {return new FenceBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> japanese_cedar_fence_gate =BW("japanese_cedar_fence_gate","a",-1,() -> {return new FenceGateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_japanese_cedar_planks =BW("smooth_japanese_cedar_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_japanese_cedar_slab =BW("smooth_japanese_cedar_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_japanese_cedar_stairs =BW("smooth_japanese_cedar_stairs","a",-1,() -> {return new StairBlock(smooth_cypress_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> lacquer_sapling =BW("lacquer_sapling","a",-1,() -> {return new SaplingBlock(new LacquerTreeGrower(),BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.GRASS).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
    ...
    public static final RegistryObject<Block> red_urushi_planks =BW("red_urushi_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> red_urushi_slab =BW("red_urushi_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> red_urushi_stairs =BW("red_urushi_stairs","a",-1,() -> {return new StairBlock(red_urushi_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> red_urushi_fence =BW("red_urushi_fence","a",-1,() -> {return new FenceBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> red_urushi_fence_gate =BW("red_urushi_fence_gate","a",-1,() -> {return new FenceGateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_red_urushi_planks =BW("smooth_red_urushi_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_red_urushi_slab =BW("smooth_red_urushi_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_red_urushi_stairs =BW("smooth_red_urushi_stairs","a",-1,() -> {return new StairBlock(smooth_red_urushi_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> black_urushi_planks =BW("black_urushi_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> black_urushi_slab =BW("black_urushi_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> black_urushi_stairs =BW("black_urushi_stairs","a",-1,() -> {return new StairBlock(black_urushi_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> black_urushi_fence =BW("black_urushi_fence","a",-1,() -> {return new FenceBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> black_urushi_fence_gate =BW("black_urushi_fence_gate","a",-1,() -> {return new FenceGateBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> smooth_black_urushi_planks =BW("smooth_black_urushi_planks","a",-1,() -> {return new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_black_urushi_slab =BW("smooth_black_urushi_slab","a",-1,() -> {return new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    public static final RegistryObject<Block> smooth_black_urushi_stairs =BW("smooth_black_urushi_stairs","a",-1,() -> {return new StairBlock(smooth_black_urushi_planks.get().defaultBlockState(),BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).sound(SoundType.WOOD).strength(1.0F, 10.0F));});
    ...
    public static final RegistryObject<Block> tawara =BF("tawara","h",-1,() -> {return new HorizonalRotateBlock(BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_YELLOW).strength(0.2F, 3.0F).sound(SoundType.GRASS));});
